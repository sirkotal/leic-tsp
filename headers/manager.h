...
public:
    ...
    /**
     * @brief Calculates the shortest path starting at one point and ending in another using an heuristic based on a greedy approach and on 2-opt optimization.
